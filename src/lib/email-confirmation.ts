...
export async function sendBookingConfirmation(data: BookingConfirmationData) {
  ...
  const addonsHtml = selectedAddons.length > 0 
    ? `
      <h3 style="color: #1f2937; font-size: 18px; margin: 20px 0 10px 0;">Zusatzoptionen:</h3>
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f9fafb;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); padding: 40px 30px; text-align: center;">
          ...
          <p style="color: #e0e7ff; font-size: 16px; margin: 0;">Ihre Buchungsbestätigung</p>
        </div>

        <!-- Content -->
        <div style="padding: 40px 30px;">
          <h2 style="color: #1f2937; font-size: 24px; font-weight: 600; margin: 0 0 20px 0;">Vielen Dank für Ihre Buchung!</h2>
          ...
          <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 24px; margin: 30px 0;">
            <h3 style="color: #1f2937; font-size: 18px; margin: 0 0 20px 0;">Buchungsdetails</h3>
            
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
              <span style="color: #6b7280; font-weight: 500;">Paket</span>
              <span style="color: #1f2937; font-weight: 600;">${packageName}</span>
            </div>
            
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
              <span style="color: #6b7280; font-weight: 500;">Zahlungsart</span>
              <span style="color: #1f2937; font-weight: 600;">${isMonthly ? 'Monatlich' : 'Einmalzahlung'}</span>
            </div>
            
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
              <span style="color: #6b7280; font-weight: 500;">Preis</span>
              <span style="color: #1f2937; font-weight: 600;">${packagePrice}</span>
            </div>
            
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0;">
              <span style="color: #6b7280; font-weight: 500;">Buchungs-ID</span>
          ...
          <!-- Total -->
          <div style="background-color: #3b82f6; color: #ffffff; border-radius: 8px; padding: 20px; margin: 30px 0; text-align: center;">
            <h3 style="color: #ffffff; font-size: 18px; margin: 0 0 10px 0;">Gesamtbetrag</h3>
            <p style="color: #ffffff; font-size: 32px; font-weight: 700; margin: 0;">${totalAmount.toFixed(2)} ${currency.toUpperCase()}</p>
          </div>
