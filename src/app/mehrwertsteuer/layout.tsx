...
export const metadata: Metadata = {
  ...
  keywords: `Mehrwertsteuer Rechner, MwSt berechnen, Brutto Netto Rechner, Steuerrechner, Umsatzsteuer, Deutschland 19% 7%, Österreich 20% 10%, Schweiz 8.1% 3.8% 2.6%, kostenlos, WebWelle`,
  ...
  openGraph: {
    ...
    siteName: 'WebWelle',
    title: `Mehrwertsteuer-Rechner | Brutto, Netto + MwSt berechnen`,
