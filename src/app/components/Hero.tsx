...
export default function Hero() {
  ...
  return (
    <section className="relative py-16 md:py-32 overflow-hidden min-h-screen flex items-center">
      ...
      {/* Overlay für bessere Lesbarkeit - dunkler Hintergrund */}
      <div className="absolute inset-0 bg-gradient-to-b from-background/40 via-background/50 to-background/70 z-10"></div>
      
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Text mit dunklem Hintergrund - Mobile optimiert */}
          <div className="bg-background backdrop-blur-md rounded-xl md:rounded-2xl p-4 md:p-8 mb-6 md:mb-8 max-w-5xl mx-auto border border-border shadow-xl">
